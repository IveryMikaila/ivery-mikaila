   ...
   <ul>
    ...
    const Education = ()=>{
        ...
        <>
         {/* College */}
        <div className='experienceHeading'>
        <h1>AAS in Advertising Marketing Communications<br/>Fashion Institute of Technology</h1>
